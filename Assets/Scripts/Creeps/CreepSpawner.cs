...
public class CreepSpawner : MonoBehaviour
{
    ...
    {
        //lazy way to prevent multiple calls to save high score on title screen
        if (GlobalVariables.HP <= 0 && SceneManager.GetActiveScene().buildIndex != 2)
        {
            saveHighScores();
        }
    ...
    public void callLevelCleared()
    {
        ...
        {// +1 added to count the creepPathCheker
